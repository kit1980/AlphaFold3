...
from src.data.tools import jackhmmer, hhblits, hhsearch, hmmsearch
from src.common import residue_constants, protein
...
def make_sequence_features(
    ...
    features["token_index"] = np.array(range(num_res), dtype=np.int32)  # added for AF3
